...
`tests/test_mcl.py` run against; `update()` is the whole sensor model and `predict_odometry()` the
...
**27 mm** RMSE against **187 mm** of raw odometry — **6.96×** — with 1200 particles and 107 of 360
